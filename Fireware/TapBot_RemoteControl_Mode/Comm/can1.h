...
#define     CAN1_APB1_CLK            36000000U   // F107 CAN1挂载APB1总线，时钟频�?6MHz
 ...
 * @param  �?
 * @retval �?
 * @note   依次调用GPIO配置、NVIC配置、CAN模式配置、滤波配�?
 */
 ...
 * @param  msg：待发送的数据缓冲区（长度�?字节�?
 *         id�?CAN报文ID（标准ID�?~0x7FF，扩展ID�?~0x1FFFFFFF�?
 *         dlc：报文数据长度（0~8字节�?
 * @retval 发送结果：0-失败�?-成功
 * @note   支持标准/扩展ID，自动判断ID类型，超时时�?00ms
 */
